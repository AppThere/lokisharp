...
//          Moved from tools/lokiprint to AppThere.Loki.Skia so that StubEngine
//          (in AppThere.Loki.LokiKit) can reference it without an upward dependency.
//          lokiprint delegates to this type via a using alias.
...
// USED BY: StubEngine (LokiKit), lokiprint CLI
// PHASE:   2
...
namespace AppThere.Loki.Skia.Testing;
